        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnglishNameTranslation = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TafsirCache", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WirdId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Juz = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ayahs_Surahs_SurahNumber",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ShareCompletionStatus = table.Column<bool>(type: "bit", nullable: false),
                    ShareStreak = table.Column<bool>(type: "bit", nullable: false),
                    ShareWirdRange = table.Column<bool>(type: "bit", nullable: false),
                    ShareReadingProgress = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadingProgress", x => x.UserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartGlobalAyah = table.Column<int>(type: "int", nullable: false),
                    EndGlobalAyah = table.Column<int>(type: "int", nullable: false),
                    CompletedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WirdCompletions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WirdCompletions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomAyahsPerDay = table.Column<int>(type: "int", nullable: true),
                    TargetCompletionDate = table.Column<DateOnly>(type: "date", nullable: true),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WirdPlans", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_WirdPlans_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SharedGoals", x => x.GroupId);
                    table.ForeignKey(
                        name: "FK_SharedGoals_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SharedGoals_Users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookmarks_UserId_SurahNumber_AyahNumber",
                table: "Bookmarks",
                columns: new[] { "UserId", "SurahNumber", "AyahNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Encouragements_ToUserId_CreatedAtUtc",
                table: "Encouragements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PasswordResetOtps_UserId_ConsumedAtUtc",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TafsirCache_SurahNumber_AyahNumber_TafsirId",
                table: "TafsirCache",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WirdCompletions_UserId_CompletionDate",
                table: "WirdCompletions",
